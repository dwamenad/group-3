...
- `g25/output/jupyter-notebook/g25-new-AdView-datalad-confounds-evs-feat-mricrogl.ipynb`
...
```bash
jupyter lab g25-new-AdView-datalad-confounds-evs-feat-mricrogl.ipynb
```
